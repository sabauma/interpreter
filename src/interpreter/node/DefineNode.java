...
public abstract class DefineNode extends SchemeNode
{
	...
	protected double writeFloat(VirtualFrame virtualFrame, double value)
	{
		virtualFrame.setDouble(this.getSlot(), value);
		return value;
	}
	
	@Specialization(contains = {"writeLong", "writeFloat", "writeBoolean"})
	...
	{
		return this.isKind(this.getSlot(), FrameSlotKind.Double);
	}
